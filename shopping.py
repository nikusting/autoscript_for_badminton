# -*- coding: utf-8 -*-
"""
Created on Tue Apr 12 19:29:36 2022
...
def login():
    ...
    browser.get("https://my.sjtu.edu.cn/ui/task")
    time.sleep(1)
    ...
    time.sleep(5)
    browser.find_element_by_xpath('/html/body/div[1]/div/div[1]/div[1]/div/div[2]/div/div[1]/div[16]/div[1]').click()
    ...
    for i in range(500):
        ...
        print(a)
        b = datetime.datetime.strptime(str(datetime.datetime.now().date())+'22:00:00', '%Y-%m-%d%H:%M:%S')     
            # 获取当前时间
        print(b)
        ...
        if n_time > a and n_time<b:
            ...
            browser.find_element_by_xpath('/html/body/div/div[2]/div/div[5]/div[2]/ul/li[3]/div/div/div[2]/h3').click()
